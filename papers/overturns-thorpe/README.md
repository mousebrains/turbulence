...
Thorpe-scale overturn analysis (`processing/thorpe.py`): the sort and
displacement scale, the Thorpe–Ozmidov link behind R_OT, overturn-validity
tests, and the known Thorpe-scale ε biases.
...
| Galbraith & Kelley (1996), *JTECH* **13**, 688–702. [doi:10.1175/1520-0426(1996)013<0688:IOICP>2.0.CO;2](https://doi.org/10.1175/1520-0426%281996%29013%3C0688:IOICP%3E2.0.CO;2) | `Galbraith_Kelley_1996_Identifying_Overturns.pdf` | Run-length + water-mass overturn validity tests — our `--min-run` gate (OCR added locally). |
