...
| Lueck, Huang, Newman & Box (1997), "Turbulence measurement with a moored instrument," *JTECH* **14**, 143–161. [doi:10.1175/1520-0426(1997)014<0143:TMWAMI>2.0.CO;2](https://doi.org/10.1175/1520-0426(1997)014%3C0143:TMWAMI%3E2.0.CO;2) | `Lueck_1997_Turbulence_Moored_Instrument.pdf` | TAMI, an early autonomous moored shear-probe instrument: four shear probes, two FP07s, **ducted rotors for the flow speed**, and accelerometers. It sampled 128 s every 5 min; peak flows were 0.15 m s⁻¹, and it resolved ε in currents as slow as 0.03 m s⁻¹. The precedent for moored and lander ε, where speed comes from a current sensor rather than a fall rate. |
