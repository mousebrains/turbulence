# stratified-turbulence-anisotropy

Isotropy criteria and the structure of stratified turbulence — the backdrop for
the VMP two-probe isotropy/anisotropy investigation (the Re_b U-curve, the
length-scale ratios, and the ε/νN² isotropy threshold).
...
| Smyth & Moum (2000), "Anisotropy of turbulence in stably stratified mixing layers," *Phys. Fluids* **12**, 1343–1362. [doi:10.1063/1.870385](https://doi.org/10.1063/1.870385) | `Smyth_Moum_2000_Anisotropy_Stratified_Mixing_Layers.pdf` | Anisotropy of dissipation-range turbulence in stratified mixing layers — length-scale ratios we can mirror with L_T/L_O. |
...
| Rehmann & Hwang (2005), "Small-scale structure of strongly stratified turbulence," *JPO* **35**, 151–164. [doi:10.1175/JPO2676.1](https://doi.org/10.1175/JPO2676.1) | `Rehmann_Hwang_2005_SmallScale_Stratified_Turbulence.pdf` | Rapid-distortion analysis of weak turbulence in strong stratification: isotropy-based ε formulas can be wrong by >3× under mean shear — a caution for the two-probe isotropy null and the ε/νN² threshold. (Rockland distributes this as TN-016; filed here as the paper.) |
