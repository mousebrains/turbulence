...
def _load_and_merge(config_path: str | None) -> dict[str, Any]:
    ...
    if config_path is not None:
        from perturb.config import load_config
...
def _cmd_init(args: argparse.Namespace) -> None:
    ...
    from perturb.config import generate_template
...
def _cmd_trim(args: argparse.Namespace) -> None:
    ...
    from perturb.pipeline import run_trim
...
def _cmd_merge(args: argparse.Namespace) -> None:
    ...
    from perturb.pipeline import run_merge
...
def _cmd_bin(args: argparse.Namespace) -> None:
    ...
    from perturb.config import DEFAULTS, merge_config, resolve_output_dir
...
def _cmd_combo(args: argparse.Namespace) -> None:
    ...
    from perturb.combo import make_combo, make_ctd_combo
    from perturb.netcdf_schema import CHI_SCHEMA, COMBO_SCHEMA, CTD_SCHEMA
