...
from microstructure_tpw.chi.fp07 import fp07_double_pole, fp07_tau, fp07_transfer, gradT_noise
...
def compute_chi_window(
    ...
    """
    from microstructure_tpw.chi.chi import _chi_from_epsilon, _default_tau_model, _iterative_fit
