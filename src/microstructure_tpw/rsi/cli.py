...
def _load_file_config(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if getattr(args, "config", None) is not None:
        from microstructure_tpw.rsi.config import load_config
...
def _merge_for_section(args: argparse.Namespace, section: str) -> dict[str, Any]:
    ...
    """
    from microstructure_tpw.rsi.config import merge_config
...
def _setup_output_dir(
    ...
    """
    from microstructure_tpw.rsi.config import resolve_output_dir, write_resolved_config
...
def _cmd_nc(args: argparse.Namespace) -> None:
    ...
    from microstructure_tpw.rsi.convert import convert_all, p_to_L1
...
def _cmd_init(args: argparse.Namespace) -> None:
    ...
    from microstructure_tpw.rsi.config import generate_template
...
def _cmd_eps(args: argparse.Namespace) -> None:
    ...
    from microstructure_tpw.rsi.dissipation import _compute_diss_one, compute_diss_file
...
def _cmd_chi(args: argparse.Namespace) -> None:
    ...
    from microstructure_tpw.rsi.chi_io import _compute_chi_one, compute_chi_file
...
def _cmd_ql(args: argparse.Namespace) -> None:
    ...
    from microstructure_tpw.rsi.quick_look import quick_look
...
def _cmd_dl(args: argparse.Namespace) -> None:
    ...
    from microstructure_tpw.rsi.diss_look import diss_look
...
def main() -> None:
    ...
    from microstructure_tpw.rsi import __version__
