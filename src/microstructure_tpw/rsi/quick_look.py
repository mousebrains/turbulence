...
from microstructure_tpw.rsi.window import compute_chi_window, compute_eps_window
...
def _compute_chi_spectra(
    ...
    """
    from microstructure_tpw.chi.batchelor import KAPPA_T
    from microstructure_tpw.chi.chi import _mle_fit_kB
    from microstructure_tpw.chi.fp07 import fp07_tau, fp07_transfer
    from microstructure_tpw.chi.fp07 import gradT_noise as _gradT_noise
