...
Structural copy of rsi/config.py, referencing perturb's own DEFAULTS
(13 sections).  Imports only ``_normalize_value`` from microstructure_tpw.rsi.config
...
from microstructure_tpw.rsi.config import _normalize_value
