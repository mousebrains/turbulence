...
These functions bridge rsi_python instrument I/O with the pure chi
computation in chi_tpw.chi.  They handle data loading, profile
...
def get_chi(
    ...
    """
    from chi_tpw.chi import _compute_profile_chi
