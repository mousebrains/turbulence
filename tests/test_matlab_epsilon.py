...
Compares Python dissipation results against *_validation.mat files
generated by matlab/generate_validation_mats.m.
...
def _load_validation(mat_path: Path) -> dict:
    """Load a *_validation.mat (v7.3/HDF5) file.

    MATLAB cell arrays are stored as datasets of object references.
    Each reference points to a dataset in the #refs# group.
    """
    out = {}
