#!/usr/bin/env python3
"""MR046 clock offset against glider husker's flight-computer clock.
...
SRC = HERE.parent / "MR046" / "DATA"
CACHE = HERE / "mr1hz"
FLIGHT = HERE / "flight_inputs.nc"
# Clock blocks, split in the glider-data gap (no MR file spans it).
BLOCK_SPLIT = np.datetime64("2013-05-10T00:00:00", "s").astype(float)
...
def solve():
    ...
    for name, in_block in (("A_2013-05-01..03", lambda t: t < BLOCK_SPLIT), ("B_2013-05-17..26", lambda t: t >= BLOCK_SPLIT)):
