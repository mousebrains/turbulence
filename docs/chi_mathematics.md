...
([`batchelor.py: batchelor_kB`](../src/microstructure_tpw/rsi/batchelor.py))
...
([`batchelor.py: batchelor_nondim`](../src/microstructure_tpw/rsi/batchelor.py))
...
([`batchelor.py: batchelor_grad`](../src/microstructure_tpw/rsi/batchelor.py))
...
([`batchelor.py: kraichnan_grad`](../src/microstructure_tpw/rsi/batchelor.py))
...
([`fp07.py: fp07_transfer`](../src/microstructure_tpw/rsi/fp07.py))
...
([`fp07.py: fp07_double_pole`](../src/microstructure_tpw/rsi/fp07.py))
...
([`fp07.py: fp07_tau`](../src/microstructure_tpw/rsi/fp07.py))
...
([`fp07.py: noise_thermchannel`](../src/microstructure_tpw/rsi/fp07.py))
...
When shear probes provide an independent estimate of epsilon (from [`get_diss`](../src/microstructure_tpw/rsi/dissipation.py)), the Batchelor wavenumber is fully determined and chi can be computed by integrating the observed temperature gradient spectrum with corrections for sensor rolloff and unresolved variance.

([`chi.py: _chi_from_epsilon`](../src/microstructure_tpw/rsi/chi.py))
...
([`chi.py: _mle_fit_kB`](../src/microstructure_tpw/rsi/chi.py))
...
([`chi.py: _iterative_fit`](../src/microstructure_tpw/rsi/chi.py))
...
Temperature gradient spectra are computed using [`csd_odas`](../src/microstructure_tpw/rsi/spectral.py) (ported from ODAS `csd_odas.m`):
...
([`chi.py: _compute_profile_chi`](../src/microstructure_tpw/rsi/chi.py))
...
- Kinematic viscosity `nu` is computed from [`visc35(T_mean)`](../src/microstructure_tpw/rsi/ocean.py)
