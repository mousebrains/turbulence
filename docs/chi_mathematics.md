...
([`batchelor.py: batchelor_kB`](../src/odas_tpw/rsi/batchelor.py))
...
([`batchelor.py: batchelor_nondim`](../src/odas_tpw/rsi/batchelor.py))
...
([`batchelor.py: batchelor_grad`](../src/odas_tpw/rsi/batchelor.py))
...
([`batchelor.py: kraichnan_grad`](../src/odas_tpw/rsi/batchelor.py))
...
([`fp07.py: fp07_transfer`](../src/odas_tpw/rsi/fp07.py))
...
([`fp07.py: fp07_double_pole`](../src/odas_tpw/rsi/fp07.py))
...
([`fp07.py: fp07_tau`](../src/odas_tpw/rsi/fp07.py))
...
([`fp07.py: noise_thermchannel`](../src/odas_tpw/rsi/fp07.py))
...
([`chi.py: _chi_from_epsilon`](../src/odas_tpw/rsi/chi.py))
...
([`chi.py: _mle_fit_kB`](../src/odas_tpw/rsi/chi.py))
...
([`chi.py: _iterative_fit`](../src/odas_tpw/rsi/chi.py))
...
Temperature gradient spectra are computed using [`csd_odas`](../src/odas_tpw/rsi/spectral.py) (ported from ODAS `csd_odas.m`):
...
([`chi.py: _compute_profile_chi`](../src/odas_tpw/rsi/chi.py))
...
- Kinematic viscosity `nu` is computed from [`visc35(T_mean)`](../src/odas_tpw/rsi/ocean.py)
