...
This document describes the mathematical foundations for computing epsilon, the rate of dissipation of turbulent kinetic energy, as implemented in `microstructure-tpw`. All equation numbers, constants, and algorithmic details correspond to the actual code in [`dissipation.py`](../src/microstructure_tpw/rsi/dissipation.py), [`spectral.py`](../src/microstructure_tpw/rsi/spectral.py), [`goodman.py`](../src/microstructure_tpw/rsi/goodman.py), [`despike.py`](../src/microstructure_tpw/rsi/despike.py), [`nasmyth.py`](../src/microstructure_tpw/rsi/nasmyth.py), and [`ocean.py`](../src/microstructure_tpw/rsi/ocean.py).
...
([`dissipation.py: _compute_profile_diss`](../src/microstructure_tpw/rsi/dissipation.py))
...
([`nasmyth.py: _nasmyth_g2`](../src/microstructure_tpw/rsi/nasmyth.py))
...
([`nasmyth.py: nasmyth`](../src/microstructure_tpw/rsi/nasmyth.py))
...
([`nasmyth.py`](../src/microstructure_tpw/rsi/nasmyth.py), [`dissipation.py: _estimate_epsilon`](../src/microstructure_tpw/rsi/dissipation.py))
...
([`spectral.py: _cosine_window`](../src/microstructure_tpw/rsi/spectral.py))
...
([`spectral.py: csd_odas`](../src/microstructure_tpw/rsi/spectral.py))
...
([`spectral.py: csd_matrix`](../src/microstructure_tpw/rsi/spectral.py))
...
([`despike.py: despike, _single_despike`](../src/microstructure_tpw/rsi/despike.py))
...
([`goodman.py: clean_shear_spec`](../src/microstructure_tpw/rsi/goodman.py))
...
([`dissipation.py: _estimate_epsilon`](../src/microstructure_tpw/rsi/dissipation.py))
...
([`dissipation.py: _inertial_subrange`](../src/microstructure_tpw/rsi/dissipation.py))
...
([`dissipation.py: _variance_correction`](../src/microstructure_tpw/rsi/dissipation.py))
...
([`ocean.py: visc35`](../src/microstructure_tpw/rsi/ocean.py))
