...
This document describes the mathematical foundations for computing epsilon, the rate of dissipation of turbulent kinetic energy, as implemented in `microstructure-tpw`. All equation numbers, constants, and algorithmic details correspond to the actual code in [`dissipation.py`](../src/odas_tpw/rsi/dissipation.py), [`spectral.py`](../src/odas_tpw/rsi/spectral.py), [`goodman.py`](../src/odas_tpw/rsi/goodman.py), [`despike.py`](../src/odas_tpw/rsi/despike.py), [`nasmyth.py`](../src/odas_tpw/rsi/nasmyth.py), and [`ocean.py`](../src/odas_tpw/rsi/ocean.py).
...
([`nasmyth.py: _nasmyth_g2`](../src/odas_tpw/rsi/nasmyth.py))
...
([`nasmyth.py: nasmyth`](../src/odas_tpw/rsi/nasmyth.py))
...
([`nasmyth.py`](../src/odas_tpw/rsi/nasmyth.py), [`dissipation.py: _estimate_epsilon`](../src/odas_tpw/rsi/dissipation.py))
...
([`spectral.py: _cosine_window`](../src/odas_tpw/rsi/spectral.py))
...
([`spectral.py: csd_odas`](../src/odas_tpw/rsi/spectral.py))
...
([`spectral.py: csd_matrix`](../src/odas_tpw/rsi/spectral.py))
...
([`despike.py: despike, _single_despike`](../src/odas_tpw/rsi/despike.py))
...
([`goodman.py: clean_shear_spec`](../src/odas_tpw/rsi/goodman.py))
...
([`ocean.py: visc35`](../src/odas_tpw/rsi/ocean.py))
